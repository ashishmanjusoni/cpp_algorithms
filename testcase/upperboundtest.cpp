...
auto k=algo::upper_bound(v.begin(),v.end(),30);
if(k!=v.end()) cout<<distance(v.begin(),k)<<endl;
auto g=algo::upper_bound(v.begin(),v.end(),60);
if(g!=v.end()) cout<<distance(v.begin(),g)<<endl;
auto h=algo::upper_bound(v.begin(),v.end(),100);
if(h!=v.end()) cout<<distance(v.begin(),h)<<endl;

vector<int> a={10,20,30,30,30,40,50,60,70,80};
auto b=algo::upper_bound(a.begin(),a.end(),30);
if(b!=a.end()) cout<<b-a.begin()<<endl;
auto c=algo::upper_bound(a.begin(),a.end(),60);
if(c!=a.end()) cout<<c-a.begin()<<endl;
auto d=algo::upper_bound(a.begin(),a.end(),100);
